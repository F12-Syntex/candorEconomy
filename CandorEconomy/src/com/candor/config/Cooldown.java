...
import com.candor.placeholder.time.TimeData;
import com.candor.utils.ComponentBuilder;
import com.candor.utils.MappyHelper;
import com.candor.utils.MappyObject;
...
public class Cooldown extends Config{
	...
	public List<String> header() {
		// TODO Auto-generated method stub
		return ComponentBuilder.createLore("Cooldown formatting will be described here",
				"Cooldown.display.coding //the format of which the cooldown will be shown",
				"Cooldown.display.complexity //the length of the cooldown in terms of time ( 2 would show seconds and minutes, while 3 would include hours )",
				"Cooldown.display.message //Cooldown message",
				"Time.<time>.short_name // short name for <time> for example shortname for seconds is \"s\"",
				"Time.<time>.seconds // the amount of seconds in your madeup/real time unit");
	}
