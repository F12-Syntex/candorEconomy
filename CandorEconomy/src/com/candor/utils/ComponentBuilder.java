...
public class ComponentBuilder {
	...
	public static List<String> createLore(boolean autoColour, String... i) {
		List<String> lore = new ArrayList<String>();
		for(String o : i.clone()) {
			lore.add(MessageUtils.translateAlternateColorCodes(o, autoColour));
		}
		return lore;
	}
	...
	public static List<String> createLore(List<String> i, boolean autoColour) {
		List<String> lore = new ArrayList<String>();
		for(String o : i) {
			lore.add(MessageUtils.translateAlternateColorCodes(o, autoColour));
		}
